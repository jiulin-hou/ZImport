...
systemctl stop zimport-web zimport-worker || true
...
for s in zimport-web zimport-worker; do
...
systemctl start zimport-web zimport-worker
sleep 1
echo "[update] 服务状态:"
systemctl is-active zimport-web zimport-worker
REMOTE_EOF
